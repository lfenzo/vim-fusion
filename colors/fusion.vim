...
" Julia Syntax
exe 'hi juliaRangeKeyword       's:blue''
exe 'hi juliaFunctionCall       's:white' cterm=bold'
exe 'hi juliaFunction           's:orange''
...
exe 'hi juliaType               's:light_blue''
exe 'hi juliaSymbol             's:purple''
exe 'hi juliaSymbols            's:purple''
exe 'hi juliaParamType          's:light_blue''
...
exe 'hi juliaBaseTypeC		      's:blue''
exe 'hi juliaBaseTypeError		  's:blue''
